...
def handle_client(client):  # Takes client socket as argument.
    ...
    msg = "\n=>[%s] hat sich mit dem Socket_Server1 verbunden!\n" % name
    ...
    while True:
        ...
        if (msg == bytes("{quit}", "utf8")):
            ...
            broadcast(bytes("%s hat die Verbindung zum Server getrennt.\n" % name, "utf8"))
            client.close()
            quit()
...
if __name__ == "__main__":
    server.listen(10)
    print("Warte auf Clients..[Socket_Server1]")
